...
[![x-cmd/install — okteto Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/okteto.svg?lang=zh)](https://x-cmd.com/install/okteto)
...
合计: **142,012** 行代码（覆盖前 5 种语言、共 **858** 个文件）。
...
- **上游仓库**: <https://github.com/okteto/okteto>
- **官网**: <https://okteto.com>
- **许可证**: Apache-2.0
...
- **Star**: 3,549 · **Fork**: 317 · **开放 issue**: 1,483 · **贡献者**: 79

## 累计统计

- **发布数**: 570 · **已合并 PR**: 3343 · **开放 PR**: 1 · **已关闭 issue**: 1448 · **开放 issue**: 35 · **提交数**: 3308

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-25 | 5 | 25 | 1 | 0 | 0 | 21 |
| last60d | 2026-07-26 | 8 | 47 | 1 | 1 | 0 | 41 |
| 90d | 2026-06-26 | 13 | 76 | 1 | 1 | 0 | 66 |
| last180d | 2026-03-28 | 22 | 160 | 1 | 1 | 0 | 148 |
| 360d | 2025-09-29 | 64 | 316 | 1 | 3 | 1 | 280 |
| last720d | 2024-10-04 | 100 | 556 | 1 | 9 | 1 | 486 |
...
okteto 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `okteto` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/okteto.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T05:38:32Z._
